    ...
    <main className="min-h-screen bg-slate-50 text-slate-900">
      <section className="border-b border-slate-200 bg-white">
        <div className="mx-auto max-w-6xl px-4 py-12">
          ...
          <h1 className="mt-4 text-3xl font-semibold sm:text-4xl">Institutional procurement, demand-first</h1>
          ...
          <div className="mt-6 flex flex-col gap-3 sm:flex-row">
            ...
            <Link href={user ? "/bulk/orders" : "/bulk"} className="inline-flex min-h-[46px] items-center justify-center rounded-xl border border-slate-300 bg-white px-6 py-3 text-sm font-semibold text-slate-800 transition hover:bg-slate-50">
      ...
      <section className="mx-auto max-w-6xl px-4 py-10">
        <div className="grid gap-4 md:grid-cols-3">
          <article className="rounded-2xl border border-slate-200 bg-white p-5 shadow-sm">
            ...
            <p className="mt-1 text-sm text-slate-600">Quantity, quality specs, county, delivery window, and budget.</p>
          </article>
          <article className="rounded-2xl border border-slate-200 bg-white p-5 shadow-sm">
            <CheckCircle2 className="h-5 w-5 text-emerald-700" />
            <h2 className="mt-3 text-lg font-semibold">2. Compare offers</h2>
            <p className="mt-1 text-sm text-slate-600">Review supplier responses and negotiate directly in chat.</p>
          </article>
          <article className="rounded-2xl border border-slate-200 bg-white p-5 shadow-sm">
            <ArrowRight className="h-5 w-5 text-emerald-700" />
            <h2 className="mt-3 text-lg font-semibold">3. Close faster</h2>
            <p className="mt-1 text-sm text-slate-600">Accept the right offer and execute with tracked follow-up.</p>
          </article>
        </div>
      </section>
    </main>
